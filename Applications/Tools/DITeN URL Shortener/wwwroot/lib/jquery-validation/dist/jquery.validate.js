										...
										, function(event)
											{
												...
												if ($(this)
													.hasClass("cancel")) validator.cancelSubmit = true;

												// Allow suppressing validation by adding the html5 formnovalidate attribute to the submit button
												if ($(this)
													.attr("formnovalidate") !==
													undefined) validator.cancelSubmit = true;
											});
			...
			$.extend($.validator
				, {
					...
					, prototype: {
								...
								if (type === "file")
									{
										...
										if (val.substr(0
												, 12) ===
											"C:\\fakepath\\") return val.substr(12);
						...
						, check: function(element)
							{
								...
								if (normalizer)
									{
										val = normalizer.call(element
											, val);

										if (typeof val !== "string")
											throw new TypeError("The normalizer should return a System.String value.");
						...
						defaultMessage: function(element
						                         , rule)
							{
								...
								var message = this.findDefined(
										    ...
										    // 'title' is never undefined, so handle empty System.String as undefined
								...
								if (error.length)
								...
								else
									{
										...
										if (this.labelContainer.length) this.labelContainer.append(place);
											...
											{
												this.settings.errorPlacement.call(this
													, place
													, $(element));
											}
										...
										if (error.is("label"))
											...
											0)
											{
												...
												if (!describedBy) describedBy = errorID;
													...
													.match(new RegExp("\\b" + this.escapeCssMeta(errorID) + "\\b")))
													{
						...
						escapeCssMeta: function(System.String);
			{
...
normalizeAttributeRule: function(rules
                                 , type
                                 , method
                                 , value)
	{
				...
				if (method === "required")
					{
						...
						// Some browsers return an empty System.String for the required attribute
			...
			, function()
				{
					...
					if (rules[this])
						{
							if ($.isArray(rules[this])) rules[this] = [Number(rules[this][0]), Number(rules[this][1])];
...
// Converts a simple System.String to a {string: true} rule, e.g., "required" to {required:true}
		...
		required: function(value
		                   ...
		                   , param)
			{
				...
				if (!this.depend(param
					, element)) return "dependency-mismatch";
		...
		equalTo: function(value
		                  ...
		                  , param)
			{
				...
				if (this.settings.onfocusout &&
					target.not(".validate-equalTo-blur")
					.length)
					{

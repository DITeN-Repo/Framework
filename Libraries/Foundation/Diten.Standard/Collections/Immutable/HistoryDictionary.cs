...
namespace Diten.Collections.Immutable
{
	...
	{
		public IEnumerator<KeyValuePair<TObjectId, TObject>> GetEnumerator()
		{
		...
		public bool ContainsKey(TObjectId key)
		{
			throw new NotImplementedException();
		}

		public bool TryGetValue(TObjectId key, out TObject value)
		{
			throw new NotImplementedException();
		}
		...
		public IImmutableDictionary<TObjectId, TObject> Clear()
		{
			throw new NotImplementedException();
		}
		...
		public IImmutableDictionary<TObjectId, TObject> Remove(TObjectId key)
		{
			throw new NotImplementedException();
		}

		public bool Contains(KeyValuePair<TObjectId, TObject> pair)
		{
			throw new NotImplementedException();
		}

		public bool TryGetKey(TObjectId equalKey, out TObjectId actualKey)
		{
			throw new NotImplementedException();
		}
	}

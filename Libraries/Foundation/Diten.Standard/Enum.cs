...
namespace Diten
{
	public static class Enum
	{
		...
		public static bool TryParse<TEnum>(string value, out TEnum result) where TEnum : struct =>
			System.Enum.TryParse(value, false, out result);
		...
		{
			var path =
				$@"{System.Environment.GetFolderPath(Parse<System.Environment.SpecialFolder>(System.Environment.SpecialFolder.System.GetNames().FirstOrDefault(p => p.Equals(new StackTrace().GetFrame(2).GetMethod().Name))))}\{Names.Default.Diten}";
		...
		public static string GetName(MethodNames methodName) => GetName(enumerator: methodName);
		...
		/// <returns>Name of a method in object inherited class.</returns>
		public static string GetName(PropertyNames propertyName) => GetName(enumerator: propertyName);
		...
		public static string GetName(this System.Enum enumerator) =>
			System.Enum.GetName(enumerator.GetType(), enumerator) ?? throw new InvalidOperationException();
		...
		public static IEnumerable<string> GetNames(this System.Enum enumerator) =>
			System.Enum.GetNames(enumerator.GetType());
	}
}
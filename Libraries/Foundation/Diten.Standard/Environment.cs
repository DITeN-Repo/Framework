...
namespace Diten
{
	...
	public class Environment : WebObject<Environment>
	{
		...
		///    Get conversation tag.
		/// </summary>
		public static DTTag ConversationBeginning => new DTTag(
		...
		public static string GetResourceString(string resource, params object[] param) => string.Format(resource, param);

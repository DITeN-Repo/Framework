...
namespace Diten.Numeric
{
	                   ...
	                   IDBit<bool>
	{
		...
		public Int32 CompareTo(bool other)
		{
		...
		///    false.
		/// </returns>
		public Boolean Equals(bool other) => System.Convert.ToBoolean(Value[0]);
		...
		/// <inheritdoc cref="IComparable{T}.CompareTo" />
		public Int32 CompareTo(DBit other)
		{
		...
		public Boolean ToBoolean(IFormatProvider provider) => System.Convert.ToBoolean(Value[0]);
		...
		public byte ToByte(IFormatProvider provider) => System.Convert.ToByte(Value[0]);
		...
		public char ToChar(IFormatProvider provider) => System.Convert.ToChar(Value[0]);
		...
		public DateTime ToDateTime(IFormatProvider provider) => System.Convert.ToDateTime(Value[0]);
		...
		public decimal ToDecimal(IFormatProvider provider) => System.Convert.ToDecimal(Value[0]);
		...
		public double ToDouble(IFormatProvider provider) => System.Convert.ToDouble(Value[0]);
		...
		public Int16 ToInt16(IFormatProvider provider) => System.Convert.ToInt16(Value[0]);
		...
		public Int32 ToInt32(IFormatProvider provider) => System.Convert.ToInt32(Value[0]);
		...
		public long ToInt64(IFormatProvider provider) => System.Convert.ToInt64(Value[0]);
		...
		public sbyte ToSByte(IFormatProvider provider) => System.Convert.ToSByte(Value[0]);
		...
		public float ToSingle(IFormatProvider provider) => System.Convert.ToSingle(Value[0]);
		...
		public System.String ToString(IFormatProvider provider) => System.Convert.ToString(Value[0]);
		...
		public ushort ToUInt16(IFormatProvider provider) => System.Convert.ToUInt16(Value[0]);
		...
		public uint ToUInt32(IFormatProvider provider) => System.Convert.ToUInt32(Value[0]);
		...
		public ulong ToUInt64(IFormatProvider provider) => System.Convert.ToUInt64(Value[0]);

...
namespace Diten.Tor
{
	...
	public enum CircuitReason
	{
		...
		/// </summary>
		[Description("TORPROTOCOL")] TorProtocol,
		...
		/// </summary>
		[Description("HIBERNATING")] Hibernating,

		/// <summary>
		///     The relay is out of memory, sockets, or circuit IDs.
		/// </summary>
		[Description("RESOURCELIMIT")] ResourceLimit,

		/// <summary>
		///     Unable to contact the relay.
		/// </summary>
		[Description("CONNECTFAILED")] ConnectFailed,

		/// <summary>
		///     The relay had the wrong OR identification.
		/// </summary>
		[Description("OR_IDENTITY")] ORIdentity,

		/// <summary>
		///     The connection failed after being established.
		/// </summary>
		[Description("OR_CONN_CLOSED")] ORConnectionClosed,

namespace Diten.Tor.Config
{
	...
	public enum ConfigurationNames
	{
		...
		[ConfigurationAssoc("BandwidthRate", Default = 1099511627776.0, Type = typeof(Bytes),
			Validation = ConfigurationValidation.NonNull | ConfigurationValidation.SizeDivision)]
		BandwidthRate,

		[ConfigurationAssoc("CircuitBuildTimeout", Default = 60, Type = typeof(int),
			Validation = ConfigurationValidation.Positive)]
		CircuitBuildTimeout,

		[ConfigurationAssoc("CircuitIdleTimeout", Default = 3600, Type = typeof(int),
			Validation = ConfigurationValidation.Positive)]
		CircuitIdleTimeout,
		...
		[ConfigurationAssoc("ControlPort", Default = 9051, Type = typeof(int),
			Validation = ConfigurationValidation.PortRange)]
		ControlPort,

		[ConfigurationAssoc("ConstrainedSockets", Default = false, Type = typeof(bool))]
		ConstrainedSockets,

		[ConfigurationAssoc("ConstrainedSockSize", Default = 8388608.0, Type = typeof(Bytes),
			Validation = ConfigurationValidation.NonNull | ConfigurationValidation.SizeDivision)]
		ConstrainedSockSize,
		...
		[ConfigurationAssoc("HashedControlPassword", Default = "", Type = typeof(string),
			Validation = ConfigurationValidation.NonNull)]
		...
		[ConfigurationAssoc("KeepalivePeriod", Default = 300, Type = typeof(int),
			Validation = ConfigurationValidation.Positive)]
		KeepAlivePeriod,
		...
		[ConfigurationAssoc("MaxCircuitDirtiness", Default = 600, Type = typeof(int),
			Validation = ConfigurationValidation.Positive)]
		MaxCircuitDirtiness,

		[ConfigurationAssoc("MaxClientCircuitsPending", Default = 32, Type = typeof(int),
			Validation = ConfigurationValidation.Positive)]
		MaxClientCircuitsPending,

		[ConfigurationAssoc("NewCircuitPeriod", Default = 30, Type = typeof(int),
			Validation = ConfigurationValidation.Positive)]
		NewCircuitPeriod,
		...
		[ConfigurationAssoc("SocksPort", Default = 9051, Type = typeof(int),
			Validation = ConfigurationValidation.PortRange)]
		SocksPort,

		[ConfigurationAssoc("SocksTimeout", Default = 120, Type = typeof(int),
			Validation = ConfigurationValidation.Positive)]
		SocksTimeout,

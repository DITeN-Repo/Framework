...
namespace Diten.Tor.Converters
{
	/// <summary>
	///     A class providing the methods necessary to convert between a <see cref="HostAuth" /> object and
	///     <see cref="System.String" /> object.
	/// </summary>
				...
				if (actual.Contains(":"))
				{
					...
					if (parts.Length != 2)
						throw new InvalidCastException(
							"A string must contain a username, or a username and password, format");

...
namespace Diten.Tor
{
	...
	public struct HostAuth
	{
		...
		/// </summary>
		public bool IsNull => username == null && password == null;
		...
		/// </summary>
		public static HostAuth Null => new HostAuth {username = null, password = null};
		...
		{
			return obj != null && obj is HostAuth && ((HostAuth) obj).password == password &&
			       ((HostAuth) obj).username == username;
		}

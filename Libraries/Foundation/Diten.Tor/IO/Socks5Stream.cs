...
namespace Diten.Tor.IO
{
	/// <summary>
	///     A class which connects to a remote address using the tor network service, and provides stream methods for
	///     communication.
	/// </summary>
	[DebuggerStepThrough]
	public sealed class Socks5Stream : System.IO.Stream
	{
		...
		/// </summary>
		/// <param name="buffer">
		///     An array of bytes. When this method returns, the buffer contains the bytes read from the current
		///     source.
		/// </param>
		/// <returns>
		...
		public int Read(byte[] buffer)
		{
			...
			if (buffer.Length == 0)
				throw new ArgumentOutOfRangeException("buffer",
					"The read buffer should be greater than zero in length");

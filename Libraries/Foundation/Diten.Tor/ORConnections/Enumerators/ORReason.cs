...
namespace Diten.Tor
{
	...
	public enum ORReason
	{
		...
		/// </summary>
		[Description("CONNECTREFUSED")] ConnectRefused,
		...
		/// </summary>
		[Description("CONNECTRESET")] ConnectReset,
		...
		/// </summary>
		[Description("NOROUTE")] NoRoute,

		/// <summary>
		///     The OR connection received a different IO error.
		/// </summary>
		[Description("IOERROR")] IOError,
		...
		/// </summary>
		[Description("PT_MISSING")] PTMissing,

...
namespace Diten.Tor
{
	...
	public enum StreamStatus
	{
		...
		/// </summary>
		[Description("NEWRESOLVE")] NewResolve,

		/// <summary>
		///     An address was re-mapped to another.
		/// </summary>
		[Description("REMAP")] Remap,

		/// <summary>
		///     A connect cell was sent along a circuit.
		/// </summary>
		[Description("SENTCONNECT")] SentConnect,

		/// <summary>
		///     A resolve cell was sent along the circuit.
		/// </summary>
		[Description("SENTRESOLVE")] SentResolve,

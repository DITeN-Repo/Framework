...
<script runat="server">
	...
	{
		Ext.Net.Desktop.GetInstance().RemoveModule("add1-module");

		var win = new Diten.Web.UI.WebControls.Window
		{
		...
		//m.Window[0].Render(btn);
		//Desktop1.Render(m.Window[0], RenderMode.RenderTo);
	...
	public void AddNewModule()
	{
		...
		var control = ControlUtils.FindControl<DesktopModuleProxy>(LoadControl("modules/TabWindow.ascx"));
	...
	{
		Ext.Net.Desktop.GetInstance().CreateWindow(new Diten.Web.UI.WebControls.Window
		{
			Title = "New window",
			Width = 300,
			Height = 300,
	...
	protected void Logout_Click(object sender,
		DirectEventArgs e)
	{
	...
	public void OnClick(object sender,
		DirectEventArgs e)
	{
		Ext.Net.X.Msg.Alert("OnClick", "DirectEventArgs");
	}

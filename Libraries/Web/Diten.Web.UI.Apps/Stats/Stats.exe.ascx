<%@ control language="C#" autoeventwireup="true" codebehind="Stats.exe.ascx.cs" inherits="Diten.Web.UI.Apps.Stats.Stats" %>
									...
									<Items>
										<diten:ButtonGroup ID="ButtonGroupServerJobs" runat="server" Title="Server Jobs" Columns="4">
											<Items>
												...
												<diten:Button ID="StatsButton2" runat="server" Text="Copy" Icon="PageCopy" Scale="Large" IconAlign="Top" RowSpan="3" ToolTip="Copy the selected items to clipboard (Ctrl+C)." OnDirectClick="ButtonCopy_Click"/>
												<diten:Button ID="StatsButton3" runat="server" Text="Paste" Icon="PagePaste" Scale="Large" IconAlign="Top" RowSpan="3" ToolTip="Paste the contents of Clipboard to the current location. (Ctrl+V)" OnDirectClick="ButtonPaste_Click"/>
												<diten:Button ID="StatsButton4" runat="server" Text="Cut" Icon="Cut" ToolTip="Move the selected items to the Clipboard. (Ctrl+X)" OnDirectClick="ButtonCut_Click"/>
												<diten:Button ID="StatsButton5" runat="server" Text="Copy path" Icon="PageCopy" ToolTip="Copy the path of selected items to the Clipboard." OnDirectClick="ButtonCopyPath_Click"/>
												<diten:Button ID="StatsButton6" runat="server" Text="Paste shortcut" Icon="PagePaste" ToolTip="Paste shortcuts to the items on the Clipboard." OnDirectClick="ButtonPasteShorcut_Click"/>
											</Items>
											<Content>
											</Content>
										</diten:ButtonGroup>

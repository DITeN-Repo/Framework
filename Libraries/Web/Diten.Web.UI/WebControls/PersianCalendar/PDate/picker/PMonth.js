...
Ext.define("Ext.picker.PMonth",
	{
		...
		beforeRender: function() {
			...
			var i = 0;
			const months = [];
			const shortName = Ext.PDate.getShortMonthName;
			const monthLen = me.monthOffset;
			const margin = me.monthMargin;
			var style = "";
		...
		setValue: function(value) {
			const me = this;
			const active = me.activeYear;
			const offset = me.monthOffset;
			var year,
				index;
